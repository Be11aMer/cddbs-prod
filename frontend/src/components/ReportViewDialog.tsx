                    ...
                    {isLoading ? (
                        ...
                        <Grid container spacing={4}>
                            ...
                            <Grid item xs={12} md={8}>
                                <Stack spacing={3}>
                                    {/* AI Provenance Card — EU AI Act Art. 50 disclosure (tiered: badge → detail) */}
                                    {data.ai_metadata ? (
                                        <AIProvenanceCard aiMetadata={data.ai_metadata} context="report" />
                                    ) : (
                                        <Alert
                                        ...
                                        >
                                            <Typography variant="subtitle2" fontWeight={700}>AI-Generated Content</Typography>
                                            <Typography variant="caption">This briefing is generated by an AI language model. Always verify claims against source articles.</Typography>
                                        </Alert>
                                    )}
